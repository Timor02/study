...
function get_sign(e) {
    ...
    return '1.0_' + encrypt()(O(e))

}


function get_xzse86(en_data) {
    val = get_sign(en_data)
    return val;
}
...
// get_xzse86('3_2.0+/api/v4/search_v3?show_all_topics=0&correction=1&q=lol&limit=20&t=general&offset=0&lc_idx=0+https://www.zhihu.com/search?type=content&q=%E7%8E%8B%E8%80%85%E8%8D%A3%E8%80%80+"AFCSt5WRcRGPTpaGSojpgMaUBCs4xxSqdTk=|1592459241"');
